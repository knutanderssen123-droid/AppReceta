...
class FamilyRecipesApp {
    ...
    // ==================== RECIPE DETAIL ====================
    viewRecipe(id, isCustom) {     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }     let recipe;      if (isCustom) {         recipe = this.myRecipes.find(r => r.customId === id);     } else {         recipe = RECIPES_DB.find(r => r.id === parseInt(id));     }      if (!recipe) {         this.showToast('⚠️ No se encontró la receta');         return;     }      const detailContainer = document.getElementById('recipe-detail');     const favBtn = document.getElementById('btn-fav-detail');     const detailScreen = document.getElementById('screen-detail');      if (!detailContainer || !favBtn || !detailScreen) {         console.error('Faltan elementos del detalle de receta en index.html');         this.showToast('⚠️ Falta la pantalla de detalle en index.html');         return;     }      this.currentDetailRecipe = recipe;      const recipeId = recipe.id || recipe.customId;     const isFav = this.isFavorite(recipeId);     favBtn.textContent = isFav ? '❤️' : '🤍';      const categories = Array.isArray(recipe.categories) ? recipe.categories : [];     const ingredients = Array.isArray(recipe.ingredients) ? recipe.ingredients : [];     const steps = Array.isArray(recipe.steps) ? recipe.steps : [];      const catLabels = {         saludable: '🥗 Saludable',         rapida: '⚡ Rápida',         ninos: '👶 Para niños',         golosa: '🍫 Golosa',         economica: '💰 Económica',         vegetariana: '🌿 Vegetariana',         fiesta: '🎉 Para fiestas',         asiatica: '🥢 Asiática',         italiana: '🇮🇹 Italiana',         mexicana: '🌮 Mexicana',         postres: '🍰 Postres',         desayunos: '☀️ Desayunos',         ensaladas: '🥗 Ensaladas',         española: '🇪🇸 Española'     };      const tagsHtml = categories.length         ? categories.map(c => `<span class="detail-tag">${catLabels[c] || c}</span>`).join('')         : '<span class="detail-tag">Sin categoría</span>';      const ingredientsHtml = ingredients.length         ? ingredients.map(i => `<li>${String(i)}</li>`).join('')         : '<li>Sin ingredientes</li>';      const stepsHtml = steps.length         ? steps.map(s => `<li>${String(s)}</li>`).join('')         : '<li>Sin pasos</li>';      const isCustomRecipe = !!recipe.customId;     const deleteBtn = isCustomRecipe         ? `<button class="btn-delete-recipe" onclick="app.deleteMyRecipe('${recipe.customId}')">🗑️ Eliminar receta</button>`         : '';      const authorHtml = recipe.author         ? `<div class="detail-author">Creada por ${recipe.author} 👨‍🍳</div>`         : '';      detailContainer.innerHTML = `         <div class="detail-hero">             <span class="detail-hero-emoji">${recipe.emoji || '🍽️'}</span>             <h2>${recipe.name || 'Receta sin nombre'}</h2>             <div class="detail-meta">                 <div class="detail-meta-item">                     <span class="detail-meta-value">⏱️ ${recipe.time || 'No indicado'}</span>                     <span class="detail-meta-label">Tiempo</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">👥 ${recipe.servings || '-'}</span>                     <span class="detail-meta-label">Personas</span>                 </div>                 <div class="detail-meta-item">                     <span class="detail-meta-value">📊 ${recipe.difficulty || 'No indicada'}</span>                     <span class="detail-meta-label">Dificultad</span>                 </div>             </div>         </div>          <div class="detail-section">             <h3>🏷️ Categorías</h3>             <div class="detail-tags">${tagsHtml}</div>         </div>          <div class="detail-section">             <h3>🛒 Ingredientes</h3>             <ul class="detail-ingredients">${ingredientsHtml}</ul>         </div>          <div class="detail-section">             <h3>👨‍🍳 Preparación</h3>             <ol class="detail-steps">${stepsHtml}</ol>         </div>          ${recipe.tip ? `         <div class="detail-section">             <h3>💡 Consejo</h3>             <div class="detail-tip">${recipe.tip}</div>         </div>         ` : ''}          ${authorHtml}          <div style="text-align: center; margin-top: 20px;">             ${deleteBtn}         </div>     `;      this.showScreen('screen-detail'); }
        let recipe;
        if (isCustom) {
